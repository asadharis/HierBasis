...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(FitAdditiveLogistic2(y, weights, ak, X, beta, intercept, max_lambda, lam_min_ratio, alpha, tol, p, J, n, ybar, nlam, max_iter, beta_is_zero, step_size, lineSrch_alpha, use_act_set, fista));
    return __result;
END_RCPP
}
// GetProx
